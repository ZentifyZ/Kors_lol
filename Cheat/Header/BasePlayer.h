...
public:
	...
	CreateUnSafeField("Assembly-CSharp", "", "HitTest", "HitTransform", HitTransform, UINT_PTR);
...
public:
	...
	CreateField("Assembly-CSharp", "", "Projectile", "previousVelocity", previousVelocity, Vector3);
	CreateField("Assembly-CSharp", "", "Projectile", "currentVelocity", currentVelocity, Vector3);
	CreateField("Assembly-CSharp", "", "Projectile", "initialVelocity", initialVelocity, Vector3);
	CreateField("Assembly-CSharp", "", "Projectile", "traveledTime", traveledTime, Vector3);
	CreateField("Assembly-CSharp", "", "Projectile", "swimRandom", swimRandom, float);
	CreateField("Assembly-CSharp", "", "Projectile", "thickness", thickness, float);
	CreateField("Assembly-CSharp", "", "Projectile", "drag", drag, float);
};
...
public:
	...
	//CreateField("Assembly-CSharp", "", "PlayerEyes", "get_position", Position, Vector3);
	CreateField("Assembly-CSharp", "", "PlayerEyes", "MovementForward", MovementForward, Vector3);
	CreateField("Assembly-CSharp", "", "PlayerEyes", "MovementForward", MovementRight, Vector3);
