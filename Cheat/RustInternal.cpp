...
{
	Globals::g_RustClientBase = (UINT_PTR)Internal::HdnGetModuleBase(xorstr_("RustClient.exe"));
	Globals::g_UnityPlayerBase = (UINT_PTR)Internal::HdnGetModuleBase(xorstr_("UnityPlayer.dll"));
	Globals::g_GameAssemblyBase = (UINT_PTR)Internal::HdnGetModuleBase(xorstr_("GameAssembly.dll"));
	Globals::g_DxgiModuleBase = (UINT_PTR)Internal::HdnGetModuleBase(xorstr_("dxgi.dll"));
